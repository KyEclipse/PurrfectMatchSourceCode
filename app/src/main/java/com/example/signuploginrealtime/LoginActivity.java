            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    if (passwordFromDB.equals(userPassword)){
                        ...
                        String firstnameFromDB = snapshot.child(userEmail).child("firstname").getValue(String.class);
                        String lastnameFromDB = snapshot.child(userEmail).child("lastname").getValue(String.class);
